...
// Railway対応: ポート設定の修正
const PORT = process.env.PORT || 3000; // Railway環境では動的ポートが設定される
...
app.listen(PORT, '0.0.0.0', () => {
  ...
  console.log(`管理画面: ${process.env.NODE_ENV === 'production' ? 'https://valerosso-fukuoka.club' : 'http://localhost:' + PORT}/admin/login`);
  
  // Railway環境での確認ログ
  if (process.env.NODE_ENV === 'production') {
    console.log('Railway本番環境で実行中');
    console.log('ポート:', PORT);
    console.log('ホスト: 0.0.0.0 (Railway対応)');
  }
});
